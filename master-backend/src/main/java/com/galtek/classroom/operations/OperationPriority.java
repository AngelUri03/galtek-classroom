    ...
    public static OperationPriority defaultFor(OperationType operationType) {
        ...
        return switch (operationType) {
            ...
            case ASSIGN_STUDENT, MOVE_STUDENT, SWAP_STUDENTS, SYNC_STUDENT_WORKSPACE,
                    ...
                    LOGOFF_WINDOWS_SESSION, SWITCH_MANAGED_ACCOUNT -> HIGH;
            case LOCK_INPUT, SHUTDOWN, RESTART, OPEN_APPLICATION, OPEN_URL, START_PROJECTION,
                    DISTRIBUTE_FILE, CREATE_FOLDER, SET_WALLPAPER, RESTORE_WALLPAPER -> NORMAL;
        };
    }
}

...
public enum ErrorCode {
    ...
    ACCOUNT_NOT_FOUND(ErrorCategory.WINDOWS_ACCOUNT, false),
    MANAGED_ACCOUNT_BINDINGS_INVALID(ErrorCategory.WINDOWS_ACCOUNT, false),
    MANAGED_CREDENTIAL_STORE_INVALID(ErrorCategory.WINDOWS_ACCOUNT, false),
    MANAGED_CREDENTIAL_PROTECTION_FAILED(ErrorCategory.WINDOWS_ACCOUNT, false),
    ...
    WINDOWS_SESSION_CHANGED(ErrorCategory.WINDOWS_SESSION, false),
    WINDOWS_LOGON_FAILED(ErrorCategory.WINDOWS_SESSION, true),
    WINDOWS_LOGON_BUSY(ErrorCategory.WINDOWS_SESSION, true),
    WINDOWS_LOGON_NOT_CONFIRMED(ErrorCategory.WINDOWS_SESSION, false),
    WINDOWS_LOGOFF_FAILED(ErrorCategory.WINDOWS_SESSION, true),
    WINDOWS_SWITCH_NOT_CONFIRMED(ErrorCategory.WINDOWS_SESSION, false),
    ...
    CREDENTIAL_NOT_PROVISIONABLE(ErrorCategory.CREDENTIAL_VAULT, false),

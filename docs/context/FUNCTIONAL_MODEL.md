...
Prompt 19D agrega solo almacenamiento seguro local de credenciales Client. No implementa provisioning remoto, Credential Provider, login/logoff real, switch real, IPC, Protobuf, gRPC, Java API ni browser policy enforcement por `PRIMARY`/`SECONDARY`.
